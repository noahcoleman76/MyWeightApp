...
export default function Goals() {
  ...
  }, [wUnits]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    <ScrollView className="flex-1 bg-white" contentContainerStyle={{ padding: 16 }}>
      <Text className="text-2xl font-semibold">Your Goal</Text>
      ...
      <View className="mt-6 p-4 rounded-xl border">
        <Text>Maintenance: <Text className="font-semibold">{maintenance} kcal</Text></Text>
        <Text className="mt-1">Daily Target: <Text className="font-semibold">{target} kcal</Text></Text>
      </View>
    </ScrollView>
  );
}
